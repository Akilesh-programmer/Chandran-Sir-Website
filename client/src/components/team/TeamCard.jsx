  ...
  <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 group border border-gray-200 hover:border-brand-purple/40 overflow-hidden">
    <div className="p-6 sm:p-8">
      ...
      <div className="flex flex-col sm:flex-row gap-6 items-start mb-6">
        {/* Photo */}
        <div className="flex-shrink-0 w-32 h-32 sm:w-36 sm:h-36 mx-auto sm:mx-0">
          <div className="relative w-full h-full rounded-xl overflow-hidden bg-gradient-to-br from-brand-purple/10 to-brand-accent/10 group-hover:scale-105 transition-transform duration-300">
            {/* Professional Placeholder */}
            <div className="absolute inset-0 flex items-center justify-center">
              <svg
                className="w-16 h-16 sm:w-18 sm:h-18 text-brand-purple/30"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <div className="absolute inset-0 rounded-xl ring-2 ring-brand-purple/20 group-hover:ring-brand-purple/40 transition-all duration-300" />
          </div>
        </div>
        ...
        <div className="flex-1 text-center sm:text-left">
          <h3
            className={`font-display font-bold text-secondary-900 mb-2 ${
              isFounder ? "text-2xl sm:text-3xl" : "text-xl sm:text-2xl"
            }`}
          >
            {member.name}
          </h3>
