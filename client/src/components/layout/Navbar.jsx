  ...
  return (
    <nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-white/70 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(91,48,140,0.12)] py-4 border-b border-white/20"
          : "bg-white/40 backdrop-blur-lg py-6 border-b border-white/10"
      }`}
      style={{
    ...
    >
      ...
      <div
        className={`lg:hidden fixed left-0 right-0 bg-white backdrop-blur-sm overflow-y-auto shadow-[0_8px_32px_0_rgba(91,48,140,0.2)] border-t border-secondary-200 will-change-transform transition-all duration-300 ease-in-out ${
          isOpen
